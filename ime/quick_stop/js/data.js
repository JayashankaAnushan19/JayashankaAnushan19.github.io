/* ============================================================
   ...
   Generated by the private Product Manager (admin/admin.html) on 19/09/2026, 09:47:51.
...
/* Site-wide promotion (banner on every page + one-time popup on Home). */
const PROMOTION = {
  "active": true,
...
/* Category -> placeholder photo. Categories not listed show an icon tile. */
...
const PRODUCTS = [
  ...
  { id: "nb-b2", shop: "newsbooze", category: "Beers, Ciders & Alcopops", name: "Foster's Lager", unit: "10x440ml", price: 11.00, brand: "Foster's", age18: true, discountPercent: 10, discountUntil: "2026-09-21" },
